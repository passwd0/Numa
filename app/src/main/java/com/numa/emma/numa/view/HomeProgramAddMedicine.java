...
import com.numa.emma.numa.adapters.ProgrammerAddMedicineListAdapter;
import com.numa.emma.numa.classes.Controller;
import com.numa.emma.numa.classes.Program;

public class HomeProgramAddMedicine extends DialogFragment {
    private Program program;
    private ProgrammerAddMedicineListAdapter listAdapterPillola;
    private ProgrammerAddMedicineListAdapter listAdapterGeneral;

    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        LayoutInflater inflater = getActivity().getLayoutInflater();
        View view = inflater.inflate(R.layout.home_program_add_medicine, null);
        ...
        listAdapterPillola = new ProgrammerAddMedicineListAdapter(getContext(), program, controller.getMedicinesPillola());
        ...
        listAdapterGeneral = new ProgrammerAddMedicineListAdapter(getContext(), program, controller.getMedicinesGeneral());
